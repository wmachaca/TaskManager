    ...
    <tr>
      <td className="px-6 py-4 whitespace-nowrap">
        {isEditing ? (
          ...
          <div className={`text-sm font-medium ${task.status === 'FINISHED' ? 'line-through text-gray-400' : 'text-gray-900'}`}>
            {task.title}
          </div>
        )}
      </td>
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
        {isEditing ? (
          ...
          <>
            <button onClick={() => setIsEditing(true)} className="text-blue-600 hover:text-blue-900 mr-3">
              Edit
            </button>
